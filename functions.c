 ...
 * @types: List of arguments of type va_list.
 * @buffer: Buffer array from where we print out.
 * @flags:  Calculates active flags
 * @width: get width.
 * @precision: Precision specification
 * @size: Size specifier
 * Return: Number of chars which will be printed
 */
 ...
 * @types: List of arguments of type va_list
 * @buffer: Buffer array from where we print out to stdout
 * @flags:  Calculates active flags
 ...
 * @types: List of arguments of type va_list.
 * @buffer: Buffer arry from where we print out to stdout.
 * @flags:  Calculates active flags
 * @width: get width specification.
 * @precision: Precision specification
 * @size: Size specifier
 ...
 * @types: Lists of arguments of type va_list
 * @buffer: Buffer array from where we print out to stdout.
 * @flags:  Calculates active flags
 * @width: get width specification.
 * @precision: Precision specification
